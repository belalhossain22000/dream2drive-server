...
const getUsersByEmail = catchAsync(async (req: Request, res: Response) => {
  const mail = req.params.email;

  const result = await userService.getUserByEmailFromDb(mail);
  sendResponse(res, {
    statusCode: httpStatus.OK,
    success: true,
    message: "Users retrieve by mail successfully!",
    data: result,
  });
});
